/* Generated automatically by the program 'build/genpreds'
   from the machine description file '/tmp/dgboter/bbs/rhev-vm11--rhe6x86_64/buildbot/rhe6x86_64--aarch64_be-none-linux-gnu/build/src/gcc/gcc/config/aarch64/aarch64.md'.  */
